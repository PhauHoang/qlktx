        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="xuly/main.php?action=capnhapthongtin" method="POST">
              ...
              <span>Lớp </span>
              <div class="form-label-group">
                <input type="text" id="inputText" class="form-control" name="lop" value="<?php echo $row['Lop']?>" required  >
              </div>
              <hr>
              <span>Khoa </span>
              <div class="form-label-group">
                <input type="text" id="inputText" class="form-control" name="khoa" value="<?php echo $row['Khoa']?>" required  >
              </div>
              <hr>
